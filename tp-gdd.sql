...
--INSERT INTO JJRD.CALIFICACIONES (COD_CALIFICACION ,ID_COMPRA, COD_PUBLICACION, CANTIDAD_ESTRELLAS, DESCRIPCION)

--	SELECT DISTINCT Calificacion_Codigo, CO.ID_COMPRA, P.COD_PUBLICACION, CALIFICACION_CANT_ESTRELLAS, CALIFICACION_DESCRIPCION
	
--	FROM  JJRD.PUBLICACION AS P, JJRD.COMPRAS AS CO, gd_esquema.Maestra AS M
	
--	WHERE P.COD_PUBLICACION = M.Publicacion_Cod AND M.Calificacion_Codigo IS NOT NULL
...
/*---MIGRACION TABLA FACTURAS------------->NO ANDA TIRA ERROR DE PK
 ...
 No se puede insertar una clave duplicada en el objeto 'JJRD.FACTURAS'. El valor de clave duplicado es (121315).
 
 
 ....YA ESTOY QUEMADOOOOOOOOO*/
