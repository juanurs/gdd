...
--============================================================
	CREATE TABLE JJRD.DOMICILIO(
		...
		ID_USUARIO INT NOT NULL IDENTITY(1,1) FOREIGN KEY REFERENCES JJRD.USUARIOS(ID_USUARIO),
...
--============================================================
	...
	COMPRA_CALIFICADA CHAR (2) NOT NULL
	);
...
--============================================================		
	...
	COD_CALIFICACION NUMERIC(18,0) IDENTITY(1,1) PRIMARY KEY,
...
/* MIGRACION USUARIO TIPO CLIENTE */  --TODO. PUBLICACIONES_GRATIS (NO ES APLICABLE PARA DATOS MIGRADOS)

/* MIGRACION USUARIO TIPO EMPRESA*/  --TODO. PUBLICACIONES_GRATIS (NO ES APLICABLE PARA DATOS MIGRADOS)
...
/* MIGRACION CLIENTES */  --TODO: FK ID_USUARIO
INSERT INTO JJRD.CLIENTE (NOMBRE, APELLIDO, TIPO_DOC, NUMERO_DOC, EMAIL)
 SELECT DISTINCT Cli_Nombre, Cli_Apeliido, 'DNI' as TIPO_DOC, Cli_Dni, Cli_Mail
 FROM gd_esquema.Maestra
 WHERE Cli_Dni is not null
GO

/* MIGRACION EMPRESA */   --TODO: FK ID_USUARIO
INSERT INTO JJRD.EMPRESA (CUIT, RAZON_SOCIAL, EMAIL)
	SELECT DISTINCT Publ_Empresa_Cuit, Publ_Empresa_Razon_Social, Publ_Empresa_Mail
	FROM gd_esquema.Maestra
