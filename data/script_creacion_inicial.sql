...
select * from JJRD.USUARIOS where USERNAME = 'nelson'
select * from JJRD.VISIBILIDAD

select * from jjrd.ROL_USUARIO where ID_USUARIO = 21
select * from JJRD.ROLES 

select * from jjrd.PREGUNTAS
select * from gd_esquema.Maestra order by Publicacion_Cod

select * from JJRD.USUARIOS where USERNAME = 'jonas'

select * from JJRD.CLIENTE where ID_USUARIO = 93
...
select * from JJRD.PREGUNTAS
12353
INSERT INTO JJRD.PREGUNTAS (COD_PUBLICACION, ID_CLIENTE, PREGUNTA_DESCRIPCION)
					VALUES (62349, 29, 'q onda con esta publicacion')
					
delete from JJRD.PREGUNTAS where ID_CLIENTE = 21
					
select ID_CLIENTE from JJRD.CLIENTE where ID_USUARIO = 93

select * from JJRD.PUBLICACION where ID_USUARIO = 21 AND PREGUNTAS ='SI'		 --nelson rojas
					
select * from JJRD.USUARIOS where ID_USUARIO = 37



SELECT DESCRIPCION FROM JJRD.PUBLICACION as pu
			JOIN JJRD.PREGUNTAS as pr on pu.COD_PUBLICACION = pr.COD_PUBLICACION
		

 WHERE pu.ID_USUARIO = 21 AND pu.PREGUNTAS = 'SI' AND pr.RESPUESTA_DESCRIPCION is null


Descripcion Publicación4999812351

SELECT * FROM JJRD.PREGUNTAS WHERE COD_PUBLICACION = 62349

select * from JJRD.USUARIOS where ID_USUARIO = 21
UPDATE JJRD.PREGUNTAS SET RESPUESTA_FECHA = GETDATE(), RESPUESTA_DESCRIPCION = 'ASD' WHERE COD_PREGUNTA = 2

SELECT * FROM JJRD.PREGUNTAS
SELECT * FROM JJRD.PUBLICACION
